...
- **BL-032** [S] Zephyr LABID port on console
...
| Ticket | Status | Waiting on (unfinished dependencies) |
|---|---|---|
| BL-032 Zephyr LABID port on console | ⬜ todo | — |
...
| BL-041 identify info status measure | ⬜ todo | BL-032[zephyr] ⬜ |
